 ...
 */
public abstract class RTPCaptureDevice extends BasicCaptureDevice implements CaptureDevice {
    private final Logger logger = LogManager.getLogger(RTPCaptureDevice.class);
     ...
     */
    protected Boolean startProducing(RTPProducer rtpProducer, SageTVConsumer sageTVConsumer,
                                     InetAddress remoteIP, Integer localPort) {
