...
public class CaptureDeviceOption extends BaseDeviceOption {
    ...
    public CaptureDeviceOption(String value, String name, String property, String description) throws DeviceOptionException {
    ...
    public String[] getValidValues() {
        ...
        for (int i = 0; i < captureDevices.size(); i++) {
            returnValue[i] = captureDevices.get(i).getEncoderName();
        }
