...
public class FloatDeviceOption extends BaseDeviceOption {
    ...
    /**
     * Create a new device option for the type <i>float</i>.
     * <p/>
     ...
     */
    public FloatDeviceOption(float value, boolean readonly, String name, String property, String description, float minValue, float maxValue) throws DeviceOptionException {
        super(DeviceOptionType.FLOAT, readonly, name, property, description);
     ...
     *                               requirements for this option.
     */
    public FloatDeviceOption(float[] values, boolean allowEmpty, boolean readonly, String name, String property, String description, float minValue, float maxValue) throws DeviceOptionException {
        super(DeviceOptionType.FLOAT, allowEmpty, readonly, name, property, description);
    ...
    public void setValue(float... newValues) throws DeviceOptionException {
        float proposedValues[] = new float[newValues.length];
